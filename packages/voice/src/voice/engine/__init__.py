"""voice.engine — pluggable TTS engine adapters.
...
``import voice.engine`` works on hosts without torch installed. Real
...
from voice.engine.fake import FakeTTSBackend
...
from voice.engine.qwen import QwenTTSBackend
